...
public class CitaService {
    ...
    private void validarCita(Cita cita) {
        ...
        if (!cita.getFin().isAfter(cita.getInicio())) {
            throw new IllegalArgumentException("La fecha y hora de finalización debe ser posterior al inicio.");
        }
        ...
        if (cita.getTratamientos() != null) {
            cita.getTratamientos().forEach(TratamientoAplicado::validar);
        }
    }
    ...
    private void validarPaciente(Paciente paciente) {
        ...
        if (paciente.getId() == null) {
            throw new IllegalArgumentException("El paciente debe estar guardado antes de crear una cita.");
        }
    }
    ...
    private void validarRango(LocalDateTime inicio, LocalDateTime fin) {
        ...
        if (!fin.isAfter(inicio)) {
            throw new IllegalArgumentException("El fin del rango debe ser posterior al inicio.");
        }
    }
